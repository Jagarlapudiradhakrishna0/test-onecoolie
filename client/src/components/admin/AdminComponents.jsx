...
export function AdminSidebar({
  ...
  return (
    <aside
      className={`fixed top-0 left-0 bottom-0 z-40 bg-[#080B12] text-white flex flex-col border-r border-[#151B28] transition-all duration-300 ease-in-out select-none ${
    ...
    <header className="sticky top-0 z-30 h-16 bg-white dark:bg-[#0A0D14] border-b border-zinc-200/90 dark:border-zinc-800/90 px-4 sm:px-6 flex items-center justify-between shadow-[0_1px_3px_rgba(0,0,0,0.02)] transition-colors select-none">
      ...
      <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
        ...
        <div className="relative" ref={notificationRef}>
          ...
          {isNotificationOpen && (
            <div
              className="absolute right-0 mt-2 w-[390px] sm:w-[450px] max-w-[94vw] bg-white dark:bg-[#0D111A] rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 z-50 overflow-hidden animate-scale-in flex flex-col font-sans"
...
export function KpiCard({
  ...
  return (
    <div
      onClick={onClick}
      className={`bg-white dark:bg-[#0D111A] border border-zinc-200/90 dark:border-zinc-800/90 rounded-xl p-4 shadow-[0_1px_3px_rgba(0,0,0,0.03)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)] dark:hover:border-zinc-700 transition-all duration-200 flex flex-col justify-between select-none ${
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold font-sans text-zinc-900 dark:text-white mt-0.5 tracking-tight">
              {value}
            </h3>
          </div>
        </div>
