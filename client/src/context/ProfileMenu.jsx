...
/* ============================================================
   PROFILE MENU — Swiss Minimal Dropdown & Settings
...
export default function ProfileMenu({ role, onNavigate }) {
  ...
  return (
    <div className="relative" ref={ref}>
                ...
                >
                  ...
                  <ArrowRight
                    className={`w-4 h-4 shrink-0 transition-transform group-hover:translate-x-0.5 ${
                      isHighlight ? 'text-blue-600' : 'text-zinc-400 group-hover:text-zinc-700'
                    }`}
                  />
                </button>
              );
      ...
      {/* Settings / Help Modals Portaled directly to document.body */}
      {modal &&
        createPortal(
          <div
