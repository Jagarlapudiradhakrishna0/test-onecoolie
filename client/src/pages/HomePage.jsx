  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-200 ${scrolled
        ? 'bg-white/95 backdrop-blur-md border-b border-zinc-200/80 shadow-xs py-2.5 sm:py-3'
        : 'bg-white/70 sm:bg-transparent backdrop-blur-xs sm:backdrop-blur-none py-3 sm:py-4 border-b border-zinc-100/50 sm:border-transparent'
        }`}
    >
